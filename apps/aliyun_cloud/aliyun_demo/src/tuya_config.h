...
#define TUYA_OPENSDK_UUID      "uuidea01d5bfab5b0838"                    // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY   "jH3yPagzWSClB8NXEY9Je9yReCyqzEOB"        // Please change the correct authkey
